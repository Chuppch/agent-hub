...
import com.chuppch.domain.agent.model.valobj.AiClientSystemPromptVO;
import com.chuppch.domain.agent.model.valobj.AiClientVO;
...
public class AiClientNode extends  AbstractArmorySupport{
    ...
    @Override
    public String beanName(String id) {
